...
$vehicleList = $vehicle->bookedVehicle();
        ...
        foreach($vehicleList as $key => $value){?>
            ...
            <div class="card-body">
                ...
                <div class="row flex-fill">
                    ...
                    <a class="btn btn-danger stretched-link cancel-vehicle" data-vehicle-user-id="<?= $value['vs_id']?>" data-vehicle-id="<?= $value['id']?>"><span>Cancel</span></a>
                    </div>
                </div>
                </div>
            </div>
        ...
        <input type="hidden" name="action" value="book_vehicle">
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="text" name="startDate" id="startDate" class="bookingDate">
					</div>
					<div class="form-group">
						<label>End Date:</label>
						<input type="text" name="endDate" id="endDate" class="bookingDate">
					</div>
				</div>
